            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <Card className="overflow-hidden group h-full flex flex-col">
                      ...
                      <CardContent className="p-4 pt-0">
                         <Button asChild variant="secondary" size="sm" className="group/button">
                            <Link href="/study-in-belarus">{t('learnMore')} <ArrowRight className="w-4 h-4 ml-1 group-hover/button:translate-x-1 transition-transform" /></Link>
                        </Button>
                      </CardContent>
                    </Card>
                  </AnimateOnScroll>
             ...
             <div className="text-center mt-12">
                <Button asChild size="lg">
                    <Link href="/study-in-belarus">{t('exploreAll')}</Link>
                </Button>
            </div>
          </div>
        </section>
