        ...
        <div>
            <section className="relative pt-24 pb-12 md:pt-32 md:pb-20 bg-card text-center">
                ...
                <div className="container mx-auto px-4 relative">
                    <AnimateOnScroll>
                        <h1 className="text-4xl md:text-6xl font-bold font-headline text-primary-foreground mb-4">Get in Touch</h1>
                        <p className="text-lg md:text-xl text-primary-foreground/90 max-w-3xl mx-auto">
                            We're here to help you with every step of your journey. Reach out to us with your questions.
                        </p>
                    </AnimateOnScroll>
                </div>
            </section>
